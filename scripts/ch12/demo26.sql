...
select numtodsinterval( 10*86400+2*3600+3*60+2.3312, 'second' ) from dual;
select to_dsinterval( '10 02:03:02.3312' ) from dual;
select interval '10 02:03:02.3312' day to second from dual;
