...
values
( 'conference room',
   to_date( '01-jan-2014 9am', 'dd-mon-yyyy hham' ),
   to_date( '01-jan-2014 10am', 'dd-mon-yyyy hham' )
);
...
begin
    ...
    :new_start_time := to_date( '01-jan-2014 9:30am', 'dd-mon-yyyy hh:miam' );
    :new_end_time := to_date( '01-jan-2014 10:00am', 'dd-mon-yyyy hh:miam' );
end;
/
